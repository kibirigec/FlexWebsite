             ...
             {status === 'success' ? (
                ...
                >
                   ...
                   <p className="text-gray-500 max-w-md">
                      Thank you for contacting us. We have received your details and will be in touch shortly.
                   </p>
                   <button 
                            ...
                            onClick={() => {
                                const message = `*New Inquiry via Website*\n\n` +
                                    ...
                                    .map(([key, value]) => {
                                        ...
                                        // Format label from camelCase key if not strictly mapped, 
                                        // but ideally we map keys to readable labels. 
                                        // For simplicity/dynamic nature, we capitalize key.
