              ...
              <AnimatePresence>
                 {status === 'success' ? (
                    ...
                    >
                       ...
                       <h3 className="text-2xl font-bold text-[#1d1d1f] mb-2">{isDesktop ? 'Message Sent!' : 'Redirecting to WhatsApp...'}</h3>
                       <p className="text-gray-500 max-w-md">
                          {isDesktop
                            ? "Thank you for reaching out. We have received your details and will get back to you shortly via email."
