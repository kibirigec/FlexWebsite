                  ...
                  <form onSubmit={handleSubmit} className="space-y-8 max-w-xl mx-auto">
                    <div className="space-y-8">
                      <div className="relative group">
                        <label className="block text-xs font-bold uppercase tracking-wider text-[#9BAB3C] mb-1">Name</label>
                        <input
                          type="text"
                          name="name"
                          value={formData.name}
                          onChange={handleChange}
                          className="w-full py-3 bg-transparent border-b border-[#9BAB3C]/30 focus:border-[#9BAB3C] text-gray-900 placeholder:text-[#9BAB3C]/50 transition-colors outline-none rounded-none"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="relative group">
                           <label className="block text-xs font-bold uppercase tracking-wider text-[#9BAB3C] mb-1">Email</label>
                           <input
                            type="email"
                            name="email"
                        ...
                        <div className="relative group">
                           <label className="block text-xs font-bold uppercase tracking-wider text-[#9BAB3C] mb-1">Phone</label>
                           <input
                            type="tel"
                            name="phone"
                      ...
                      <div>
                        <label className="block text-xs font-bold uppercase tracking-wider text-[#9BAB3C] mb-4">I'm interested in</label>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          {servicesOptions.map((option) => (
                            ...
                            >
                              ...
                              />
                              <span className={`text-sm ${formData.selectedServices.includes(option) ? 'text-[#9BAB3C] font-medium' : 'text-gray-500'} group-hover:text-[#9BAB3C] transition-colors`}>
                                {option}
                              </span>
                            </label>
                          ))}
                      ...
                      <div className="relative group">
                        <label className="block text-xs font-bold uppercase tracking-wider text-[#9BAB3C] mb-1">Message</label>
                        <textarea
                          name="eventDescription"
                          value={formData.eventDescription}
                          onChange={handleChange}
                          className="w-full py-3 bg-transparent border-b border-[#9BAB3C]/30 focus:border-[#9BAB3C] text-gray-900 placeholder:text-[#9BAB3C]/50 transition-colors outline-none rounded-none min-h-[100px] resize-y"
