                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Event Planning</h5>
                              <p className="hidden text-sm md:block">
                                Expertise in Event Management and Execution
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Equipment Hire</h5>
                              <p className="hidden text-sm md:block">
                                Top-notch Lighting and Sound Solutions
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Decor Services</h5>
                              <p className="hidden text-sm md:block">
                                Bespoke Decor for Every Occasion
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Strategic Event Planning and Evaluation
                              </p>
                            </div>
                          </a>
                        </div>
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                See Our Past Events and Highlights
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Insights and Tips for Event Success
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          <div className="max-w-none grid w-full grid-cols-1 grid-rows-[auto_auto_auto_auto] items-start gap-y-2 md:block">
                            <a href="#" className="flex flex-col py-2">
                              ...
                              <div className="mt-2 flex max-w-[18rem] flex-col justify-start md:mt-0">
                                ...
                                <p className="text-sm">
                                  Stay Updated on Event Innovations
                                </p>
                                <div className="mt-2">
                                  <Button
                                    title="Read more"
