...
function App() {
  ...
  const heroImage = "/blue-stage-lights-light-show.jpg";
  const eventImage = "/blue-stage-lights-light-show.jpg";
      ...
      <section className="relative bg-gray-900 text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 md:py-48">
          ...
          <p className="text-[17px]/6 mb-8 max-w-2xl">
            Build Your Event with Durable Aluminum Trusses & Stages
          </p>
          <Link to="/contact">
      ...
      <section className="py-12 bg-[#F2F2F2]">
        <div className="max-w-3xl mx-auto text-center px-6">
          ...
          <p className="text-[17px]/6 text-[#86868b] ">
            Need a solid foundation for your event? Our Aluminum Truss & Stages
            provide safe and stable platforms for performances, presentations,
            and more.
          </p>
        </div>
      </section>
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <ul className="space-y-1 text-[17px]/5 text-[#E0E0E0]">
                <li className="flex items-start gap-2">
                  <span className="text-[#9BAB3C]">•</span>Strong and
                  lightweight, perfect for both indoor and outdoor events.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#9BAB3C]">•</span>Customizable sizes to
                  fit any space.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#9BAB3C]">•</span> We provide expert
                  technicians for quick setup and perfect stage setup.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#9BAB3C]">•</span>No hidden fees – just
                  simple, transparent pricing with multiple payment methods like
                  Cash, PayPal, Visa, or Mobile Money for your convenience.
                </li>
                {/* <li className="flex items-start gap-2">
