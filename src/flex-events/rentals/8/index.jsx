            ...
            <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="text-lg font-medium text-gray-800">
                      Customized designs to match your theme and style.{" "}
                    </h3>
                  </div>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="text-lg font-medium text-gray-800">
                      Quick setup and hassle-free rentals. Make your special day
                      or corporate event stand out—book now and pay with Visa or
                      Mobile Money.
                    </h3>
                  </div>
                </li>
