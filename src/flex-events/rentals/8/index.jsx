      ...
      <section className="py-12 bg-[#F2F2F2]">
        <div className="max-w-3xl mx-auto text-center px-6">
          ...
          <p className="text-[17px]/6 text-[#86868b] ">
            Take control of the music with our DJ Equipment rental. Whether
            you're an experienced DJ or just want to add a professional touch to
            your own party, we have everything you need!.
          </p>
        </div>
      </section>
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <ul className="space-y-1 text-[17px]/5 text-[#E0E0E0]">
                <li className="flex items-start gap-2">
                  <span className="text-[#9BAB3C]">•</span>Customized designs to match your theme and style.

                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#9BAB3C]">•</span>Affordable packages for every budget.
                ...
                <li className="flex items-start gap-2">
                  <span className="text-[#9BAB3C]">•</span>Quick setup and
                  hassle-free rentals. Make your special day or corporate event
                  stand out—book now and pay with Visa or Mobile Money.
                </li>
                {/* <li className="flex items-start gap-2">
