      ...
      <section className="relative bg-gray-900 text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 md:py-48">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-2xl">
            Transform your vision into reality with our premium event planning and execution services.
          </p>
          <button className="bg-[#9BAB3C] hover:bg-[#8a9a30] text-white px-8 py-4 rounded-full text-lg font-medium transition transform hover:scale-105">
            Book Your Event
          </button>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Donec sed odio dui. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Sed posuere consectetur est at lobortis.
              </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            <div className="text-2xl font-semibold text-[#9BAB3C] mb-6">Eventique</div>
