            ...
            <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="text-lg font-medium text-gray-800">
                      Affordable, high-quality sound systems that cater to any
                      size event.
                    </h3>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="text-lg font-medium text-gray-800">
                      Choose from a variety of setups tailored to your needs:
                      from intimate gatherings to large parties.
                    </h3>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="text-lg font-medium text-gray-800">
                      We provide expert technicians for quick setup and
                      perfect sound tuning.{" "}
                    </h3>
                  </div>
                </li>
                <li className="flex items-start">
